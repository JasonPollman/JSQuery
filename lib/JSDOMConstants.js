...
/**
* Whether or not to poll selector stats.
* If true, ./Stat.js will store information about the selectors and their performance.
* @type {Boolean}
*/
...
/**
* The selector character for finding elements by uid.
* @type {String}
*/
exports.UID_SELECTOR_MAP = ':';

/**
* Replaces circular parent references with the parent's id.
* Passed as an argument to JSON.stringify.
*/
exports.REPLACE_CIRCULAR_PARENTS = function REPLACE_CIRCULAR_PARENTS(key, value) {
